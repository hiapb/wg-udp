...
setup_udp2raw_client() {
  ...
  local remote_port="$2"  # 出口 udp2raw 监听端口
  local local_port="$3"   # 本机 udp2raw 本地监听端口
  local psk="$4"
